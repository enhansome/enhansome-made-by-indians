...
* **[Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,399 | 🐛 826 | 🌐 TypeScript | 📅 2026-09-16** by [Liyas Thomas](https://github.com/liyasthomas)<br>
  A free, fast and beautiful API request builder.

### > 15k 🌟

* **[Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 32,117 | 🐛 2,373 | 🌐 TypeScript | 📅 2026-09-19** by [Hasura](https://github.com/hasura)<br>
  Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.

### > 10k 🌟

* **[Kitty](https://github.com/kovidgoyal/kitty) ⭐ 34,984 | 🐛 13 | 🌐 Python | 📅 2026-09-19** by [Kovid Goyal](https://github.com/kovidgoyal)<br>
  A cross-platform, fast, feature full, GPU based terminal emulator.

### > 5k 🌟

* **[ERPNext](https://github.com/frappe/erpnext) ⭐ 39,383 | 🐛 1,847 | 🌐 Python | 📅 2026-09-19** by [Frappe](https://github.com/frappe)<br>
  Open Source Alternative to SAP.

* **[Calibre](https://github.com/kovidgoyal/calibre) ⭐ 25,953 | 🐛 6 | 🌐 Python | 📅 2026-09-20** by [Kovid Goyal](https://github.com/kovidgoyal)<br>
  Calibre is an e-book manager. It can view, convert, edit and catalog e-books in all of the major e-book formats. It can also talk to e-book reader devices. It can go out to the internet and fetch metadata for your books. It can download newspapers and convert them into e-books for convenient reading. It is cross platform, running on Linux, Windows and macOS.

* **[Responsively App](https://github.com/responsively-org/responsively-app) ⭐ 25,186 | 🐛 322 | 🌐 TypeScript | 📅 2026-09-20** by [Manoj Vivek](https://github.com/manojVivek) and [Suresh](https://github.com/esprush)<br>
...
* **[OpenEBS](https://github.com/openebs/openebs) ⭐ 9,814 | 🐛 37 | 📅 2026-09-20** by [OpenEBS](https://github.com/openebs)<br>
  Leading Open Source Container Attached Storage, built using Cloud Native Architecture, simplifies running Stateful Applications on Kubernetes.

* **[Fission](https://github.com/fission/fission) ⭐ 8,922 | 🐛 50 | 🌐 Go | 📅 2026-09-15** by [Fission](https://github.com/fission)<br>
  Fast and Simple Serverless Functions for Kubernetes.

### > 1k 🌟

* **[Chatwoot](https://github.com/chatwoot/chatwoot) ⭐ 36,988 | 🐛 1,451 | 🌐 Ruby | 📅 2026-09-19** by [Chatwoot](https://github.com/chatwoot)<br>
  A simple and elegant live chat software. An opensource alternative to Intercom, Zendesk, Drift, Crisp etc.

* **[Bagisto](https://github.com/bagisto/bagisto) ⭐ 28,137 | 🐛 23 | 🌐 PHP | 📅 2026-09-18** by [Bagisto](https://github.com/bagisto)<br>
  A Free and Opensource laravel eCommerce framework built for all to build and scale your business.

* **[Karate](https://github.com/intuit/karate) ⭐ 8,958 | 🐛 15 | 🌐 Java | 📅 2026-09-19** by [Peter Thomas](https://github.com/ptrthomas)<br>
...
* **[Project Travel Mate](https://github.com/project-travel-mate/Travel-Mate) ⭐ 1,338 | 🐛 37 | 🌐 Java | 📅 2022-06-13** by [Prabhakar Gupta](https://github.com/prabhakar267/) and [Swati Garg](https://github.com/Swati4star)<br>
...
* **[ToolJet](https://github.com/ToolJet/ToolJet/) ⭐ 40,943 | 🐛 1,225 | 🌐 JavaScript | 📅 2026-09-20** by [Navaneeth Pk](https://github.com/Navaneeth-pk)<br>
...
* **[LeetCode Rating Predictor](https://github.com/Sagargupta16/LeetCode_Rating_Predictor) ⭐ 7 | 🐛 1 | 🌐 Python | 📅 2026-09-19** by [Sagar Gupta](https://github.com/Sagargupta16)<br>
  LSTM-based contest rating predictor for LeetCode with 85%+ accuracy. Built with FastAPI, TensorFlow, and React.

* **[Ledger Sync](https://github.com/Sagargupta16/ledger-sync) ⭐ 7 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-18** by [Sagar Gupta](https://github.com/Sagargupta16)<br>
...
* **[Inji](https://github.com/mosip/inji) ⭐ 38 | 🐛 294 | 🌐 TypeScript | 📅 2026-09-17** <br>
