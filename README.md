# 🇮🇳 Awesome Made by Indians with stars
...
* **[Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,020 | 🐛 777 | 🌐 TypeScript | 📅 2026-08-05** by [Liyas Thomas](https://github.com/liyasthomas)<br>
  A free, fast and beautiful API request builder.

### > 15k 🌟

* **[Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 32,081 | 🐛 2,374 | 🌐 TypeScript | 📅 2026-08-11** by [Hasura](https://github.com/hasura)<br>
  Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.

### > 10k 🌟

* **[Kitty](https://github.com/kovidgoyal/kitty) ⭐ 34,382 | 🐛 10 | 🌐 Python | 📅 2026-08-13** by [Kovid Goyal](https://github.com/kovidgoyal)<br>
  A cross-platform, fast, feature full, GPU based terminal emulator.

### > 5k 🌟

* **[ERPNext](https://github.com/frappe/erpnext) ⭐ 38,002 | 🐛 1,936 | 🌐 Python | 📅 2026-08-13** by [Frappe](https://github.com/frappe)<br>
  Open Source Alternative to SAP.

* **[Calibre](https://github.com/kovidgoyal/calibre) ⭐ 25,626 | 🐛 6 | 🌐 Python | 📅 2026-08-12** by [Kovid Goyal](https://github.com/kovidgoyal)<br>
  Calibre is an e-book manager. It can view, convert, edit and catalog e-books in all of the major e-book formats. It can also talk to e-book reader devices. It can go out to the internet and fetch metadata for your books. It can download newspapers and convert them into e-books for convenient reading. It is cross platform, running on Linux, Windows and macOS.

* **[Responsively App](https://github.com/responsively-org/responsively-app) ⭐ 25,105 | 🐛 317 | 🌐 TypeScript | 📅 2026-08-02** by [Manoj Vivek](https://github.com/manojVivek) and [Suresh](https://github.com/esprush)<br>
...
* **[OpenEBS](https://github.com/openebs/openebs) ⭐ 9,795 | 🐛 41 | 📅 2026-08-13** by [OpenEBS](https://github.com/openebs)<br>
  Leading Open Source Container Attached Storage, built using Cloud Native Architecture, simplifies running Stateful Applications on Kubernetes.

* **[Fission](https://github.com/fission/fission) ⭐ 8,895 | 🐛 58 | 🌐 Go | 📅 2026-08-11** by [Fission](https://github.com/fission)<br>
  Fast and Simple Serverless Functions for Kubernetes.

### > 1k 🌟

* **[Chatwoot](https://github.com/chatwoot/chatwoot) ⭐ 35,772 | 🐛 1,314 | 🌐 Ruby | 📅 2026-08-13** by [Chatwoot](https://github.com/chatwoot)<br>
  A simple and elegant live chat software. An opensource alternative to Intercom, Zendesk, Drift, Crisp etc.

* **[Bagisto](https://github.com/bagisto/bagisto) ⭐ 27,972 | 🐛 38 | 🌐 PHP | 📅 2026-08-12** by [Bagisto](https://github.com/bagisto)<br>
  A Free and Opensource laravel eCommerce framework built for all to build and scale your business.

* **[Karate](https://github.com/intuit/karate) ⭐ 8,920 | 🐛 16 | 🌐 Java | 📅 2026-08-12** by [Peter Thomas](https://github.com/ptrthomas)<br>
  Karate is the only open-source tool to combine API test-automation, mocks, performance-testing and even UI automation into a single, unified framework.

* **[AI Chatbot framework](https://github.com/alfredfrancis/ai-chatbot-framework) ⭐ 2,165 | 🐛 11 | 🌐 TypeScript | 📅 2025-05-21** by [Alfred Francis](https://github.com/alfredfrancis)<br>
  A python chatbot framework with Natural Language Understanding and Artificial Intelligence.

* **[Project Travel Mate](https://github.com/project-travel-mate/Travel-Mate) ⭐ 1,337 | 🐛 37 | 🌐 Java | 📅 2022-06-13** by [Prabhakar Gupta](https://github.com/prabhakar267/) and [Swati Garg](https://github.com/Swati4star)<br>
...
* **[IndicNLP Library](https://github.com/anoopkunchukuttan/indic_nlp_library) ⭐ 642 | 🐛 34 | 🌐 Python | 📅 2024-06-07** by [Anoop Kunchukuttan](https://github.com/anoopkunchukuttan/indic_nlp_library) ⭐ 642 | 🐛 34 | 🌐 Python | 📅 2024-06-07<br>
...
* **[ToolJet](https://github.com/ToolJet/ToolJet/) ⭐ 38,596 | 🐛 1,118 | 🌐 JavaScript | 📅 2026-08-13** by [Navaneeth Pk](https://github.com/Navaneeth-pk)<br>
  Opensource internal tool builder. An alternative to Retool, AppSmith, JetAdmin, Internal.io etc

* **[Kundera](https://github.com/Impetus/Kundera) ⭐ 903 | 🐛 175 | 🌐 Java | 📅 2020-02-11** by [Impetus](https://github.com/Impetus)<br>
...
* **[Gasper](https://github.com/sdslabs/gasper) ⭐ 439 | 🐛 47 | 🌐 Go | 📅 2026-03-19** by [SDS Labs, IIT Roorkee](https://github.com/sdslabs)<br>
...
* **[Webzash](https://github.com/prashants/webzash) ⭐ 221 | 🐛 54 | 🌐 PHP | 📅 2021-07-20** by [Prashant Shah](https://github.com/prashants/webzash) ⭐ 221 | 🐛 54 | 🌐 PHP | 📅 2021-07-20<br>
  Easy to use web based double entry accounting software in PHP - MySQL under MIT License.

* **[Rubeus](https://github.com/sdslabs/Rubeus) ⭐ 182 | 🐛 26 | 🌐 C++ | 📅 2023-07-22** by [SDS Labs, IIT Roorkee](https://github.com/sdslabs)<br>
  A cross platform 2D game engine written in C++ for beginners.

* **[LeetCode Rating Predictor](https://github.com/Sagargupta16/LeetCode_Rating_Predictor) ⭐ 7 | 🐛 1 | 🌐 Python | 📅 2026-08-10** by [Sagar Gupta](https://github.com/Sagargupta16)<br>
  LSTM-based contest rating predictor for LeetCode with 85%+ accuracy. Built with FastAPI, TensorFlow, and React.

* **[Ledger Sync](https://github.com/Sagargupta16/ledger-sync) ⭐ 5 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-09** by [Sagar Gupta](https://github.com/Sagargupta16)<br>
...
* **[Inji](https://github.com/mosip/inji) ⭐ 36 | 🐛 299 | 🌐 TypeScript | 📅 2026-08-11** <br>
