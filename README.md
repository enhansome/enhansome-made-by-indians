...
* **[Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,101 | 🐛 802 | 🌐 TypeScript | 📅 2026-08-25** by [Liyas Thomas](https://github.com/liyasthomas)<br>
  A free, fast and beautiful API request builder.

### > 15k 🌟

* **[Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 32,100 | 🐛 2,373 | 🌐 TypeScript | 📅 2026-08-19** by [Hasura](https://github.com/hasura)<br>
  Blazing fast, instant realtime GraphQL APIs on Postgres with fine grained access control, also trigger webhooks on database events.

### > 10k 🌟

* **[Kitty](https://github.com/kovidgoyal/kitty) ⭐ 34,598 | 🐛 10 | 🌐 Python | 📅 2026-08-26** by [Kovid Goyal](https://github.com/kovidgoyal)<br>
  A cross-platform, fast, feature full, GPU based terminal emulator.

### > 5k 🌟

* **[ERPNext](https://github.com/frappe/erpnext) ⭐ 38,505 | 🐛 1,819 | 🌐 Python | 📅 2026-08-26** by [Frappe](https://github.com/frappe)<br>
  Open Source Alternative to SAP.

* **[Calibre](https://github.com/kovidgoyal/calibre) ⭐ 25,725 | 🐛 6 | 🌐 Python | 📅 2026-08-26** by [Kovid Goyal](https://github.com/kovidgoyal)<br>
  Calibre is an e-book manager. It can view, convert, edit and catalog e-books in all of the major e-book formats. It can also talk to e-book reader devices. It can go out to the internet and fetch metadata for your books. It can download newspapers and convert them into e-books for convenient reading. It is cross platform, running on Linux, Windows and macOS.

* **[Responsively App](https://github.com/responsively-org/responsively-app) ⭐ 25,134 | 🐛 319 | 🌐 TypeScript | 📅 2026-08-02** by [Manoj Vivek](https://github.com/manojVivek) and [Suresh](https://github.com/esprush)<br>
...
* **[OpenEBS](https://github.com/openebs/openebs) ⭐ 9,801 | 🐛 40 | 📅 2026-08-26** by [OpenEBS](https://github.com/openebs)<br>
  Leading Open Source Container Attached Storage, built using Cloud Native Architecture, simplifies running Stateful Applications on Kubernetes.

* **[Fission](https://github.com/fission/fission) ⭐ 8,913 | 🐛 48 | 🌐 Go | 📅 2026-08-25** by [Fission](https://github.com/fission)<br>
  Fast and Simple Serverless Functions for Kubernetes.

### > 1k 🌟

* **[Chatwoot](https://github.com/chatwoot/chatwoot) ⭐ 36,220 | 🐛 1,355 | 🌐 Ruby | 📅 2026-08-26** by [Chatwoot](https://github.com/chatwoot)<br>
  A simple and elegant live chat software. An opensource alternative to Intercom, Zendesk, Drift, Crisp etc.

* **[Bagisto](https://github.com/bagisto/bagisto) ⭐ 27,988 | 🐛 31 | 🌐 PHP | 📅 2026-08-25** by [Bagisto](https://github.com/bagisto)<br>
  A Free and Opensource laravel eCommerce framework built for all to build and scale your business.

* **[Karate](https://github.com/intuit/karate) ⭐ 8,928 | 🐛 10 | 🌐 Java | 📅 2026-08-24** by [Peter Thomas](https://github.com/ptrthomas)<br>
...
* **[IndicNLP Library](https://github.com/anoopkunchukuttan/indic_nlp_library) ⭐ 645 | 🐛 34 | 🌐 Python | 📅 2024-06-07** by [Anoop Kunchukuttan](https://github.com/anoopkunchukuttan/indic_nlp_library) ⭐ 645 | 🐛 34 | 🌐 Python | 📅 2024-06-07<br>
...
* **[ToolJet](https://github.com/ToolJet/ToolJet/) ⭐ 40,765 | 🐛 1,165 | 🌐 JavaScript | 📅 2026-08-25** by [Navaneeth Pk](https://github.com/Navaneeth-pk)<br>
...
* **[Ledger Sync](https://github.com/Sagargupta16/ledger-sync) ⭐ 6 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-16** by [Sagar Gupta](https://github.com/Sagargupta16)<br>
...
* **[Inji](https://github.com/mosip/inji) ⭐ 36 | 🐛 299 | 🌐 TypeScript | 📅 2026-08-24** <br>
